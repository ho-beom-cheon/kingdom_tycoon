...
namespace KingdomTycoon.Editor
{
    public static class P13RecruitmentSetup
    {
        ...
        private static void GenerateScreen()
        {
            ...
            Text("Eyebrow", safe.transform, "ROYAL RECRUITMENT OFFICE  ·  CONTENT.11", 17, TextAlignmentOptions.Left, new Vector2(.022f, .935f), new Vector2(.45f, .985f), new Color32(123, 215, 192, 255));
            ...
            Text("TavernSub", tavernRoot.transform, "주점 Lv.1  ·  C~A 등급  ·  잠금 1명", 18, TextAlignmentOptions.Right, new Vector2(.45f, .89f), new Vector2(.965f, .95f), new Color32(159, 184, 175, 255));
            var candidates = new Button[5]; var candidateLabels = new TMP_Text[5];
            for (int index = 0; index < 5; index++)
            {
                candidates[index] = Button($"P13_CANDIDATE_{index + 1}", tavernRoot.transform, $"<size=17>B</size>\n<b>후보 {index + 1}</b>\n<size=18>전사</size>\n<size=16>750 G</size>", new Color32(57, 66, 60, 255), 21);
            ...
            Text("BannerEyebrow", banner.transform, "LIMITED ARCANE CONTRACT  ·  STANDARD", 16, TextAlignmentOptions.Left, new Vector2(.05f, .84f), new Vector2(.70f, .95f), new Color32(111, 222, 202, 255));
            ...
            Text("HistorySub", historyRoot.transform, "최근 100건  ·  영수증과 결과 Instance를 함께 보존", 18, TextAlignmentOptions.Right, new Vector2(.45f, .88f), new Vector2(.95f, .95f), new Color32(154, 180, 171, 255));
