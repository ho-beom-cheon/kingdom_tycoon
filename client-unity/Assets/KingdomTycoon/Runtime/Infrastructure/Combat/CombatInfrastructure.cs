...
namespace KingdomTycoon.Infrastructure.Combat
{
    ...
    public sealed class CanonicalCombatCatalog
    {
        ...
        public CanonicalCombatCatalog(ContentCatalog catalog)
        {
            ...
            int requiredRegionCount = catalog.ContentVersion is CompileTimeActiveContentVersionProvider.P12ContentVersion or CompileTimeActiveContentVersionProvider.P13ContentVersion or CompileTimeActiveContentVersionProvider.P14ContentVersion or CompileTimeActiveContentVersionProvider.P15ContentVersion ? 5 : 1;
