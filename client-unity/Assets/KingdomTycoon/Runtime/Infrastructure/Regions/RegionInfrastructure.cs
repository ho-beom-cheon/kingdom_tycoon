...
namespace KingdomTycoon.Infrastructure.Regions
{
    public sealed class P12RegionCatalog
    {
        ...
        {
            if (catalog?.ContentVersion is not (CompileTimeActiveContentVersionProvider.P12ContentVersion or CompileTimeActiveContentVersionProvider.P13ContentVersion or CompileTimeActiveContentVersionProvider.P14ContentVersion or CompileTimeActiveContentVersionProvider.P15ContentVersion))
    ...
    public sealed class RegionGameService : IAppService, IRegionDeploymentPolicy
    {
        ...
        {
            if (!game.IsBootstrapped || game.CurrentDocument.Value<string>("contentVersion") is not (CompileTimeActiveContentVersionProvider.P12ContentVersion or CompileTimeActiveContentVersionProvider.P13ContentVersion or CompileTimeActiveContentVersionProvider.P14ContentVersion or CompileTimeActiveContentVersionProvider.P15ContentVersion))
                throw new RegionDomainException("P12_CONTENT_VERSION_UNSUPPORTED");
