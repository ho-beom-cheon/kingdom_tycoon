...
namespace KingdomTycoon.Infrastructure.Production
{
    ...
    public sealed class P09ProductionCatalog
    {
        ...
        {
            if (catalog?.ContentVersion is not (CompileTimeActiveContentVersionProvider.P09ContentVersion or CompileTimeActiveContentVersionProvider.P10ContentVersion or CompileTimeActiveContentVersionProvider.P11ContentVersion)) throw new ProductionDomainException("P09_CONTENT_MISSING");
    ...
    public sealed class P09StoreStockSink : IStoreStockSink
    {
        ...
        public void AddEquipment(JObject document, string templateId, string instanceId, string qualityId, Guid operationId, string contentVersion)
        {
            ...
            if (contentVersion is CompileTimeActiveContentVersionProvider.P10ContentVersion or CompileTimeActiveContentVersionProvider.P11ContentVersion)
            {
    ...
    public sealed class ProductionGameService : IAppService
    {
        ...
        {
            if (!game.IsBootstrapped || content.Catalog?.ContentVersion is not (CompileTimeActiveContentVersionProvider.P09ContentVersion or CompileTimeActiveContentVersionProvider.P10ContentVersion or CompileTimeActiveContentVersionProvider.P11ContentVersion)) throw new ProductionDomainException("P09_CONTENT_MISSING");
