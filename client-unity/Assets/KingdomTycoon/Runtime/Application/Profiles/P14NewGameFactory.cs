...
{
    public sealed class P14NewGameFactory : INewGameFactory
    {
        private readonly JObject template;

        public P14NewGameFactory(string templateJson) =>
        ...
        public JObject CreateDraft(string saveId, string profileId, DateTimeOffset now)
        {
            ...
            document["gameVersion"] = "1.0.0-p14";
            document["contentVersion"] = CompileTimeActiveContentVersionProvider.P14ContentVersion;
