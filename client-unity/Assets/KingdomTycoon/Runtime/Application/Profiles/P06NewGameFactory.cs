...
{
    public sealed class P06NewGameFactory : INewGameFactory
    {
        private readonly JObject template;
        public P06NewGameFactory(string templateJson) => template = StrictJson.ParseObject(templateJson ?? throw new ArgumentNullException(nameof(templateJson)));
        ...
        public JObject CreateDraft(string saveId, string profileId, DateTimeOffset now)
        {
            ...
            document["contentVersion"] = CompileTimeActiveContentVersionProvider.P06ContentVersion;
