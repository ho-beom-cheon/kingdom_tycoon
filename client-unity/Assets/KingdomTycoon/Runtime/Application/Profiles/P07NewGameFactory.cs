...
{
    public sealed class P07NewGameFactory : INewGameFactory
    {
        private readonly JObject template;

        public P07NewGameFactory(string templateJson) =>
        ...
        public JObject CreateDraft(string saveId, string profileId, DateTimeOffset now)
        {
            ...
            document["contentVersion"] = CompileTimeActiveContentVersionProvider.P07ContentVersion;
