...
{
    public sealed class P08NewGameFactory : INewGameFactory
    {
        private readonly JObject template;

        public P08NewGameFactory(string templateJson) =>
        ...
        public JObject CreateDraft(string saveId, string profileId, DateTimeOffset now)
        {
            ...
            document["gameVersion"] = "1.0.0-p08";
            document["contentVersion"] = CompileTimeActiveContentVersionProvider.P08ContentVersion;
